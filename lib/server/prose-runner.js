...
- Cite source URLs inline as normal markdown links: e.g. "Eton scored 79%
  Grade 9 ([source](https://example.com/results))." Use only URLs that
  appear in the tool results — never invent.
