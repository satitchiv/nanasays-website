...
Choose ONE of THREE outputs. At most ONE proposal per call (cap = 2 globally, but emit 1).

A. {}    (no proposal — pick this when none of B/C fit cleanly)
