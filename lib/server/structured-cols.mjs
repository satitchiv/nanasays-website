...
//
// 2026-07-05: generic `<sport>_offering` dims (golf, swimming, rowing, …)
// also read sports_profile — pulled from the registry so a new sport
// added there can never silently score 0 for lack of the column.
export const BIG_COLS_BY_DIM = {
  // 2026-07-05: sport_breadth (whole-programme scorer) also reads
  // sports_profile — same registration rule as the generic offering dims.
  sports_profile:    new Set(['tennis_strength', 'rugby_standing', 'football_strength', 'cricket_strength', 'hockey_strength', 'sport_breadth', ...GENERIC_SPORT_DIM_NAMES]),
