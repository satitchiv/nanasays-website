...
test('research verdict v3 model constants are present in source', () => {
  ...
  // v3.1 (2026-05-26): hash payload version bumped 4 → 5 when
  // recommenderRanking was added to the payload (so a Refresh that
  // re-ranks the shortlist invalidates cached verdicts atomically).
  assert.match(generator, /version:\s*5,/)
