...
//
// rr-8-build3-sibling-gender-year (Codex r3 P1, 2026-05-21): the schema
// grew to include child_gender + child_year. All three sub-objects
// (fields, confidence, corrections) now have to include them too —
// otherwise the strict schema parse fails on the minimal payload.
