...
export const FAMOUS_SHORT_NAMES = Object.freeze({
  ...
  bedales:      'bedales',
  // Sevenoaks added for N3 (2026-05-15). Parent question P29 ("How is this
  // school different from Sevenoaks?") needed bare-form resolution because
  // "Sevenoaks School" has only one distinctive word (≥5 chars) so the
  // rule-2 word-boundary detector skips it, and rule-1 needs the full name
  // ("sevenoaks school") which parents rarely type. Unambiguous: Sevenoaks
  // is one school in this DB.
  sevenoaks:    'sevenoaks-school',
});
