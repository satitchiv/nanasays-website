...
export const DIMENSIONS = {
  tennis_strength: {
    ...
    format: (row, school) => {
      ...
      const alumni = (t.notable_alumni ?? [])
        ...
        .join(', ');
      return [
        `${school.name} (${school.slug}) — tennis.`,
  ...
  football_strength: {
    ...
    format: (row, school) => {
      ...
      return [
        `${school.name} (${school.slug}) — football.`,
  ...
  cricket_strength: {
    ...
    format: (row, school) => {
      ...
      return [
        `${school.name} (${school.slug}) — cricket.`,
  ...
  hockey_strength: {
    ...
    format: (row, school) => {
      ...
      return [
        `${school.name} (${school.slug}) — hockey.`,
  ...
  academic_strength: {
    ...
    format: (row, school) => {
      ...
      return [
        `${school.name} (${school.slug}) — academics.`,
  ...
  pastoral_model: {
    ...
    format: (row, school) => {
      ...
      const ratio = row?.wellbeing_staffing?.ratio_per_pupil;
      return [
        `${school.name} (${school.slug}) — pastoral.`,
