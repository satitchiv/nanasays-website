...
export const DIMENSIONS = {
  ...
  ethos_match: {
    enabled: true,  // T4.16 Gap B (2026-05-09): ctx.parent.ethos_pref now flows from onboarding/Brief.
    label:           'Ethos match',
  ...
  intl_share: {
    enabled: true,  // T4.16 Gap B (2026-05-09): ctx.parent.intl_pref now flows from onboarding/Brief.
  ...
  device_policy: {
    enabled: true,  // T4.16 Gap B (2026-05-09): ctx.parent.phone_pref now flows from onboarding/Brief.
