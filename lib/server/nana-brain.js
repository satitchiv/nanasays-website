...
export function buildStructuredBlock(structured, notionBackfill) {
  if (!structured && !notionBackfill) return '(no structured data)';
  const lines = [];
  if (structured) {
...
${buildStructuredBlock(retrieval.structured, retrieval.notion_backfill)}
