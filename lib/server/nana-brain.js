...

{
  ...
  "sources_used": [{ "section_id": "", "section_label": "", "source_url": "<URL copied verbatim from supplied context (EXCERPT, REGULATORY RECORDS, or UMBRELLA CONTEXT), or empty if structured-only>", "source_type": "", "school_slug": "<slug only when UMBRELLA has a COMPARISON SCHOOL section: which school's facts back this citation (copy slug verbatim from umbrella header); omit otherwise>" }],
