...
test('builder spec.build call site threads notion through', () => {
  // RRV-5 (2026-07-20): profile added so brief-aware builders (e.g.
  // buildBoardingLifeFit) can judge fit against what the family asked for.
  assert.match(source, /spec\.build\(\{ meta, struct, notion, profile \}\)/)
})
