...
export const DATABASE_TOPIC_CANDIDATES: DatabaseTopicCandidate[] = [
  ...
  { id: 'faith_character', label: 'School faith and character', evidencePaths: ['school_life.faith_character'] },
  ...
  { id: 'school_ethos', label: 'School ethos and values', evidencePaths: ['school_life.ethos'] },
  { id: 'sports_coaching', label: 'Sports coaching staff', evidencePaths: ['sports_profile.coaching_staff'] },
  { id: 'sports_competitive_tier', label: 'Sports competitive level', evidencePaths: ['sports_profile.competitive_tier'] },
  ...
  { id: 'school_setting', label: 'School setting', evidencePaths: ['location_profile.setting', 'location_profile.setting_note'] },
  { id: 'international_community', label: 'International community', evidencePaths: ['student_community.dominant_nationalities', 'student_community.nationalities_count', 'student_community.nationalities_mentioned'] },
]
