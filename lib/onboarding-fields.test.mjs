...
test('FAMILY_CONSTANT_FIELD_NAMES contains the 4 user-spec fields', () => {
  // 2026-05-19: ethos_pref + intl_pref removed from the inheritance allowlist
  // when the Brief form dropped those fields. See onboarding-fields.ts:235
  // comment for context.
  const expected = [
    'home_region',
    'boarding_pref',
  ...
  assert.deepEqual([...FAMILY_CONSTANT_FIELD_NAMES], expected,
    'family-constant allowlist must match the user-confirmed 4 fields')
})
