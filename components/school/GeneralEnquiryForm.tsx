...
export default function GeneralEnquiryForm({ schoolName }: Props) {
            ...
            {sent ? (
              <div style={{ textAlign: 'center', padding: '16px 0' }}>
                ...
                <p style={{ fontSize: 14, color: muted, lineHeight: 1.7 }}>
                  Your enquiry about {schoolName} has been received. We will be in touch at {form.email}.
                </p>
              </div>
            ) : (
              <>
                ...
                <p style={{ fontSize: 13, color: muted, marginBottom: 24, lineHeight: 1.6 }}>
                  Fill in your details and we will follow up with admissions information.
                </p>

                <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                  {/* School of interest — read-only */}
                  <div>
                  ...
                  <div>
                    <label style={{ fontSize: 12, fontWeight: 700, color: navy, display: 'block', marginBottom: 6 }}>
                      Phone number <span style={{ color: muted, fontWeight: 400 }}>(optional)</span>
                    </label>
                    <input
                      type="tel"
                  ...
                  <div>
                    ...
                    <textarea
                      placeholder="We are relocating and are looking for an IB school for our daughter..."
                      value={form.message}
