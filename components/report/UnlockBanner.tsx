    ...
    return (
      <div className="unlock-banner unlock-banner-success">
        ...
        <div className="unlock-banner-body">
          <div className="unlock-banner-title">Unlocked. All 29 school reports are now yours.</div>
    ...
    return (
      <div className="unlock-banner unlock-banner-cta">
        <div className="unlock-banner-body">
          ...
          <div className="unlock-banner-sub">Unlock the full Deep Research for this school and 28 others.</div>
        </div>
