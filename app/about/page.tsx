...
export const metadata: Metadata = {
  ...
  description: isPaidModeOn()
    ? 'Deep research reports on 140 UK independent schools. Full fees breakdown, ISI inspection history, financial health, safeguarding record, and Nana — your AI school advisor.'
    : 'Independent research on 140 UK independent schools. Fees, inspection history, university destinations, signature programmes, and parent-fit signals — free to browse.',
      ...
      <main>
        ...
        <section className="lp-hero">
          ...
          <div className="lp-hero-ctas">
            {paidModeOn && <Link href="/signup" className="lp-cta-primary">Create free account →</Link>}
            <Link href="/schools" className={paidModeOn ? 'lp-cta-secondary' : 'lp-cta-primary'}>Browse 140 schools</Link>
          </div>
          <p className="lp-hero-proof">
            {paidModeOn
              ? '140 UK independent schools analysed · £39/month · Cancel any time'
              : '140 UK independent schools analysed · Free to browse'}
          </p>
        </section>
        ...
        <section className="lp-how">
          ...
          <h2 className="lp-section-title">{paidModeOn ? 'Three steps to a decision you can trust' : 'Independent research on every school'}</h2>
          <p className="lp-section-sub">{paidModeOn
            ? 'Every school gets a full research dossier. The free profile gives you the facts. The unlock gives you the intelligence.'
            : 'Every school gets a research dossier — facts, fees, inspection record, and parent-fit signals.'}</p>
          <div className="lp-steps">
            ...
            <div className="lp-step">
              ...
              <span className="lp-step-icon">📄</span>
              <h3>Read the school profile</h3>
              <p>{paidModeOn
                ? 'Unlock the full dossier — ISI inspection quotes, charity Commission financials, safeguarding record, policy transparency ratings, and parent-fit verdict.'
                : 'Every school profile pulls together fees, ages, inspection record, university destinations and the signature programmes that make each school distinctive.'}</p>
            </div>
            <div className="lp-step">
              <span className="lp-step-num">STEP 03</span>
              <span className="lp-step-icon">💬</span>
              <h3>{paidModeOn ? 'Chat with Nana' : 'Use what you find'}</h3>
              <p>{paidModeOn
                ? 'Ask Nana anything about the school. She reads the full research file and answers in plain English — with citations to the source.'
                : 'Walk into open days knowing what to ask. Compare profiles side by side. The directory is public and free.'}</p>
            </div>
          </div>
        </section>
        ...
        <section className="lp-schools">
          ...
          <p className="lp-section-sub" style={{ marginBottom: 40 }}>
            {paidModeOn
              ...
              : 'Every school in the directory has been individually researched.'}
          </p>
